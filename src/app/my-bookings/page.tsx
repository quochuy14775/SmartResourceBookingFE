    ...
    <DashboardLayout>
      <div className="fade-in">
        ...
        <Card style={{ background: 'white', borderRadius: '16px', padding: '3rem', textAlign: 'center' }}>
          <i className="pi pi-calendar-plus" style={{ fontSize: '4rem', color: '#667eea', marginBottom: '1rem' }}></i>
          <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#1f2937' }}>My Bookings</h2>
          <p style={{ color: '#6b7280', marginBottom: '2rem' }}>
            This feature is under development. You'll be able to view and manage your own bookings here.
          </p>
        </Card>
      </div>
    </DashboardLayout>
